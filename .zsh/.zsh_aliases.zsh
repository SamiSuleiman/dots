...
# ytdl
alias ytdl='yt-dlp'
alias ytdl480='yt-dlp -f "bv[height=480]+ba/b[height=480]"'
alias ytdl720='yt-dlp -f "bv[height=720]+ba/b[height=720]"'
alias ytdl1080='yt-dlp -f "bv[height=1080]+ba/b[height=1080]"'
