    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          vim.keymap.set('n', 'gra', vim.lsp.buf.code_action, { buffer = event.buf, desc = 'LSP: Go to code action' })
          vim.keymap.set('n', 'grD', vim.lsp.buf.declaration, { buffer = event.buf, desc = 'LSP: Go to declaration' })
          vim.keymap.set('n', 'grr', vim.lsp.buf.references, { buffer = event.buf, desc = 'LSP: Go to references' })
          vim.keymap.set('n', 'grn', vim.lsp.buf.rename, { buffer = event.buf, desc = 'LSP: Rename' })
          vim.keymap.set('n', 'grd', vim.lsp.buf.definition, { buffer = event.buf, desc = 'LSP: Go to definition' })
